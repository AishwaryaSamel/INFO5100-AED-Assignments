...
public class LoginScreen extends javax.swing.JPanel {
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        for(User user: list){
        if(comboUser.getSelectedItem().equals(user.getUserName()) && txtPword.getText().equals(user.getPassword())){
    ...
    private void populateList(){
        ...
        DefaultComboBoxModel dm = new DefaultComboBoxModel(vector);
...
//        if(list.get(0).getRole().equalsIgnoreCase("CUSTOMER")){
